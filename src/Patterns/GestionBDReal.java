    ...
    public void Peticion(Object[] args) {
        ...
        switch(caso){
            case "CREARTABLA":
            {
                ...
                crear.operation(arg);
                Aplicacion.estadoOperacion = "Se ha creado la tabla " + nombreTabla + "";
                break;
            }
            case "MODIFICARTABLA":
            {
                ...
                Aplicacion.estadoOperacion = "Se ha modificado la tabla " + nombreTabla + "";
                break;
            }
            case "ELIMINARTABLA":
            {
                ...
                Aplicacion.estadoOperacion = "Se ha eliminado la tabla " + nombreTabla + "";
                break;
            }
            case "CREARREGISTRO":
            {
                ...
                Aplicacion.estadoOperacion = "Se agrego el registro a la tabla " + nombreTabla + "";
                break;
            }
            ...
            case "ELIMINARREGISTRO":
            {
                ...
                Aplicacion.estadoOperacion = "Se elimino un registro de la tabla " + nombreTabla + "";
                break;
            }
            case "SELECCIONAR":
            {
                ...
                Aplicacion.estadoOperacion = "Se seleccionarion registros de la tabla " + nombreTabla + "";
                break;
            }
            case "UNIR":
            {
                ...
                Aplicacion.estadoOperacion = "Se uniron las tablas " + nombreTabla1 + " y " + nombreTabla2;
                break;
            }
            default:
                throw new Error("Lo sentimos, algo ha salido mal");
